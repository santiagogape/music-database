...
public class MainController {
    ...
    public void init(MainDatabase mainDatabase, Path tempFolder, MP3Processor mp3Processor) {
        this.mainDatabase = mainDatabase;
        this.tempFolder = tempFolder;
        this.mp3Processor = mp3Processor;
        System.out.println("main init");
        filesTabController.init(this.mp3Processor,fileSongListener,this.tempFolder);
    }
